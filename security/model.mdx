...
The server doest **not** store the secrets with itself after having decrypted them. This is a completely stateless operation and can be validated by auditing the source code.
